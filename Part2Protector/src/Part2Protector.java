    ...
    */    
    ...
    public class msgProcessor implements Runnable{
        ...
        for (File f:CCDFilesToUpload){
            try {
                    f.renameTo(new File(CCDUploadFileDir+f.getName())); //need to add logic for occassions when filename exists
                } catch (Exception e){
                    e.printStackTrace();
                }
        }
        ...
        for (File f:ADTFilesToUpload){
            try {
                    f.renameTo(new File(ADTUploadFileDir+f.getName())); //need to add logic for occassions when filename exists
                } catch (Exception e){
                    e.printStackTrace();
                }
        }
